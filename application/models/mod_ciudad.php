    ...
    */
    ...
    class mod_ciudad extends CI_Model {
        ...
        */
        ...
        /**
         * Initialize get_ciudades()
         * 
         * Esta función retorna el listado de ciudades o una ciudad específica según los parámetros enviados
         * 
         * @access public
         * @param string $select 
         * @param array $where 
        ...
        */
        public function get_ciudades($select = "*", $where = array(), $or_where = array(), $join = array()){
