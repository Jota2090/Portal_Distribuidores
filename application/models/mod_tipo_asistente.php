    ...
    */
    ...
    class mod_tipo_asistente extends CI_Model {
        ...
        */
        ...
        /**
         * Initialize get_tipos_asistente()
         * 
         * Esta función retorna el listado de tipos o un tipo específico de los asistentes según los parámetros enviados
         * 
         * @access public
         * @param array $select 
         * @param array $where 
        ...
        */
        public function get_tipos_asistente($select = array("0" => "*"), $where = array(), $or_where = array(), $join = array()){
            ...
            $this->db->order_by("ta_nombre", "asc"); 
