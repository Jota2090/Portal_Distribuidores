...
<div class="cuerpo_modal">
    <?php    
        $js = "id='lista_asistente' class='form_modal_input' style='width:65%' onchange='cambiar(\"main/listado_asistentes_agregados/0\",\"lista_asistente\", \"asistente_listado\");'";
...
<div class="cuerpo_modal">
    <div id="asistente_listado" class="contenido_cuerpo_modal" style="height: 300px;"></div>
</div>
