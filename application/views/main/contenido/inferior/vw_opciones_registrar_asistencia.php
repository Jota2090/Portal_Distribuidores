...
?>
        <div class="titulo_cuerpo_modal" style="margin-bottom: 0px; margin-top: 10px;">
            <span class="tabs">
                ...
                <span id="tab_menu_agregados" class="tabs_content selected_boton_blanco_centro" onclick="tabs('agregados','izq','0','blanco','asistentes_agregados_cursos/<?php echo $curso_id;  ?>/<?php echo $lista_id;  ?>','asistente_lista_curso');">
                    Asistentes Agregados
                </span>
                <span class="boton_blanco_centro" style="border-left: 3px #cccccc solid; height: 24px; "></span>
                <span id="tab_menu_disponibles" class="tabs_content boton_blanco_centro" onclick="tabs('disponibles','der','0','blanco','asistentes_disponibles_cursos/<?php echo $curso_id; ?>/<?php echo $lista_id;  ?>','asistente_lista_curso');">
