...
<script>
    $(document).ready(function() {
        $('#usuarios').dataTable({
            "ajax": '<?php echo base_url()."usuarios/listar_usuarios/1";?>',
            "order": [[ 1, "asc" ]],
            "columns": [
                { "data": "nombre" ,
                ...
                },
                {
                    "data": "cedula",
                    "render": function ( data ) {
                                return '<div class="acciones" onclick="activar(\'usuario\',\'id='+data+'&tipo=inactivos\');">'+
                                         '<a href="javascript:">Activar</a>'+
                                       '</div>'+
                                       '<div class="acciones" onclick="eliminar(\'usuario\',\'id='+data+'&tipo=inactivos\');">'+
