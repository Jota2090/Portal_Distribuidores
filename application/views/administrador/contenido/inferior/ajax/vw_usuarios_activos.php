...
<script>
    $(document).ready(function() {
        $('#usuarios').dataTable({
            "ajax": '<?php echo base_url()."usuarios/listar_usuarios";?>',
            "order": [[ 1, "asc" ]],
            "columns": [
                { "data": "nombre" ,
                ...
                },
                {
                    "data": "cedula",
                    "render": function ( data ) {
                                return '<div class="acciones" onclick="inactivar(\'usuario\',\'id='+data+'&tipo=activos\');">'+
                                         '<a href="javascript:">Inactivar</a>'+
                                       '</div>'+
                                       '<div class="acciones" onclick="eliminar(\'usuario\',\'id='+data+'&tipo=activos\');">'+
