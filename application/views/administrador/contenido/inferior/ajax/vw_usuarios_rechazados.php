...
<script>
    $(document).ready(function() {
        $('#usuarios').dataTable({
            "ajax": '<?php echo base_url()."usuarios/listar_usuarios/3";?>',
            "order": [[ 1, "asc" ]],
            "columns": [
                { "data": "nombre" ,
                ...
                },
                {
                    "data": "cedula",
                    "render": function ( data ) {
                                return '<div class="acciones" onclick="activar(\'usuario\',\'id='+data+'&tipo=rechazados\');">'+
                                         '<a href="javascript:">Activar</a>'+
                                       '</div>'+
                                       '<div class="acciones" onclick="eliminar(\'usuario\',\'id='+data+'&tipo=rechazados\');">'+
