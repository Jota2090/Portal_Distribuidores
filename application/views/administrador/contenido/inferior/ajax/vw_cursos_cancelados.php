...
<script>
    ...
    {
        $('#cursos').dataTable({
            "ajax": '<?php echo base_url()."cursos/listar_cursos/0/C";?>',
            "order": [[ 1, "asc" ]],
            "columns": [
                { "data": "nombre" },
                { "data": "fecha_inicio" ,
                ...
                { "data": "estado" },
                {
                    ...
                    "render": function ( data ) {
                                return '<div class="acciones" onclick="ver_detalles(\'curso\',\'id='+data+'\');">'+
                                       ...
                                       '</div>'+
                                       '<div class="acciones" onclick="activar(\'curso\',\'id='+data+'&tipo=cancelados\');">'+
                                         '<div style="margin-top: 1px;"><a href="javascript:">Activar</a></div>'+
                                       '</div>';
                              }
                }
            ],
