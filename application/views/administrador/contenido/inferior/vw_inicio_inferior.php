        ...
        <div class="filas">
            ...
            ?>
                        <div class="cursos_destacados">
                            <div class="titulo_curso_destacados" onclick="document.location.href='<?php echo base_url().'administrador/ver_informacion_cursos/'.$row->cur_id; ?>'">
                                <div class="top">&nbsp;</div>
                                <div class="body">
                            ...
                            <div class="cuerpo_curso_destacados" onclick="document.location.href='<?php echo base_url().'administrador/ver_informacion_cursos/'.$row->cur_id; ?>'">
                                <div class="fecha">
                                    <?php 
